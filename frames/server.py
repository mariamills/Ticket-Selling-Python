...
def establish_connection(client):
    ...
    try:
        ...
        match command:
            ...
            #****Update for view tickets
            case "view_tickets": 
                handle_view_tickets(client)
            case _:
...
#***Update for viewing tickts***
def handle_view_tickets(client):
    ...
    #c.execute("SELECT * FROM concerts LIMIT 2")
